...
void stackVersusList()
{
    ...
    // Here is how to cas as a parent type to get access to a method that is not defined in the subclass.
    ...
    // Here is how t cast as a parent type to get access to a method that is not defined in the subclass.
...
void queueVersusList()
{
    ...
    cout << "Here is the in order removal in a ueue: " << endl;
    wordQueue.clear();
